...
class FullScreenItemPage(QFrame):
    ...
    def show_item(self, item_name, item_index, image_prefix, bg_fallback, emoji_fallback, back_index):
        ...
        image_path = f"{image_prefix}_{item_index}.png"
...
class BathroomPage(QFrame):
    def __init__(self, app):
        ...
        self.options_data = [
            ...
            ("WASH",     "I need to wash my hands/face.",     "#F9E79F", "wash_pic.png",     0, 2),
            ("CLOTHES",  "I need help changing clothes.",     "#D7BDE2", "clothes_pic.png",  1, 0),
